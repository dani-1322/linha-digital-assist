      ...
      <section id="inicio" className="relative bg-deep py-16 text-deep-foreground sm:py-24">
        ...
        <div className="section-shell relative grid items-center gap-14 lg:grid-cols-[1.02fr_.98fr]">
          ...
          <div className="relative mx-auto w-full max-w-xl pb-8 reveal">
            ...
            <div className="absolute -bottom-3 -right-2 w-36 rounded-[1.2rem] border-4 border-deep bg-background p-2 shadow-2xl sm:right-5"><div className="overflow-hidden rounded-[.75rem] bg-surface-cool"><div className="grid min-h-48 place-items-center p-3 text-center"><div><Coffee className="mx-auto text-primary"/><p className="mt-3 font-display text-sm font-bold">Café da Vila</p><p className="mt-2 text-[10px] text-muted-foreground">Menu e horários sempre à mão.</p><span className="mt-3 inline-block rounded bg-primary px-3 py-1.5 text-[9px] font-bold text-primary-foreground">Como chegar</span></div></div></div></div>
          </div>
        </div>
      </section>
